    ...
    e(
      "div",
      {
        ...
        style: {
          ...
          maxHeight: "85vh",
          overflowY: "auto",
          background: "linear-gradient(135deg, #1e1b4b, var(--panel-darker))",
      ...
      e(
        ...
        e("h2", { className: "scene-title", style: { margin: 0, color: "var(--gold)", fontSize: "1.5rem" } }, "🏆 Sala della Fama (Hall of Fame)"),
        e("button", { className: "modal-close-btn", onClick: onClose, "aria-label": "Chiudi", style: { background: "none", border: "none", color: "var(--gold)", fontSize: "1.5rem", cursor: "pointer" } }, "✕")
      ),

      e("p", { style: { color: "var(--text-dim)", fontSize: "0.92rem", marginBottom: "20px" } }, "Ecco l'albo d'oro delle squadre campioni che hanno trionfato nella Lega Pokémon e sono state incoronate per l'eternità!"),
              ...
              e(
                ...
                e(
                  ...
                  e(
                    ...
                    e("span", { style: { fontWeight: "bold", fontSize: "1.1rem", color: "var(--gold-light)" } }, `Campione di ${entry.genName}`),
                    entry.isNuzlocke && e(
                      "span",
                      { style: { background: "var(--danger)", color: "#fff", padding: "2px 6px", borderRadius: "4px", fontSize: "0.72rem", fontWeight: "bold" } },
                      "💀 NUZLOCKE"
                    )
                  ),
                  e("span", { style: { fontSize: "0.8rem", color: "var(--text-dim)" } }, entry.timestamp)
                ),
                e(
                  "div",
      ...
      entries.length > 0 &&
        e(
          ...
          e("button", { className: "resume-new-btn", style: { background: "rgba(239, 68, 68, 0.2)", color: "var(--danger)", border: "1px solid var(--danger)", padding: "6px 12px", fontSize: "0.85rem" }, onClick: handleClear }, "🗑️ Svuota Sala della Fama"),
